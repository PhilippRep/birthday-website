...
const startImages = [
    { src: "DSCF5081.jpg", style: { top:"3vh", left:"50%", transform:"translateX(-50%)" } },
...
let questions = [
    ...
    { q: "Wie viele Geruchsrezeptoren hat ein Hund?", a:["220 Mio", "50 Mio", "500 Mio"], correct: 0 },
    ...
    { q: "Warum gibt es kaum Säugetiere in Neuseeland?", a:["Kälte", "Isolation", "Vulkane"], correct: 1 },
    { q: "Was ist Loch Ness?", a:["See", "Fluss", "Gebirge"], correct: 0 },
    { q: "Warum Quarter-Life-Crisis?", a:["Geld", "Orientierung", "Gesundheit"], correct: 1 },
    { q: "Welche Hunderasse gilt als besonders intelligent?", a:["Border Collie", "Pudel", "Deutscher Schäferhund"], correct: 0 },
    ...
    { q: "Hast du noch Lust weiter zu machen?", a:["Ja", "Nein"], correct: 0 },
    { q: "Ok, weiter gehts... 🐶 ", a:["Na gut!"], correct: 0 },
    { q: "Auf welcher Seite fährt man in England?", a:["Rechts", "Links", "Beidseitig"], correct: 1 },
    { q: "Warum war Kreta wichtig?", a:["Bodenschätze", "Klima", "Handel",], correct: 2 },
    ...
    { q: "Was ist der Union Jack?", a:["Flagge UK", "Flagge Englands", "Militärflagge"], correct: 0 },
    { q: "Typisches Instrument Schottlands?", a:["Geige", "Dudelsack", "Flöte"], correct: 1 },
    { q: "Sind Erdbeeren echte Beeren?", a:["Ja", "Nur im Sommer", "Nein"], correct: 2 },
    { q: "Welche Kultur war auf Kreta?", a:["Römer", "Minoer", "Ägypter"], correct: 1 },
    { q: "Wer sind die Māori?", a:["Ureinwohner", "Einwanderer", "Sprache"], correct: 0 },
    { q: "Nachteil von Vanlife?", a:["Zu viel Platz", "Zu viele Möbel", "Wenig Privatsphäre"], correct: 2 },
    ...
    { q: "Ende der 20er bedeutet?", a:["25–27", "30–32", "27–29"], correct: 2 },
    ...
    { q: "Welcher Sinn ist bei Hunden am stärksten ausgeprägt?", a:["Sehsinn", "Hörsinn", "Geruchssinn"], correct: 2 },
    ...
    { q: "Naaaaaaa.... freust du dich aufs Ende", a:["Jaaaaaaaaa"], correct: 0 },
    { q: "Du hast es bald geschafft! 😜", a:["Jesus Kweist, los jetzt!"], correct: 0 },
    { q: "Was gab es 1997 NICHT?", a:["Internet", "Smartphones verbreitet", "Computer"], correct: 1 },
    { q: "Welche Farbe hat ein Eisbär wirklich?", a:["Weißes Fell über heller Haut", "Schwarz", "Transparentes Fell über dunkler Haut"], correct: 2 },
    { q: "Wo befindet sich der Großteil der Masse einer Pflanze?", a:["Aus CO₂ aus der Luft", "Aus dem Boden", "Aus Wasser"], correct: 0 },
    { q: "Was ist Glas eigentlich?", a:["Festkörper", "Flüssigkeit", "Amorpher Feststoff"], correct: 2 },
    ...
    { q: "Was ist die Hauptstadt der Türkei?", a:["Istanbul", "Izmir", "Ankara"], correct: 2 },
    ...
    { q: "Was misst man in Kelvin?", a:["Energie", "Druck", "Temperatur"], correct: 2 },
    { q: "Was ist schneller: Licht oder Strom?", a:["Licht", "Strom", "Kommt darauf an"], correct: 2 },
    { q: "Was ist ein Virus?", a:["Lebewesen", "Nicht-lebendig, aber biologisch aktiv", "Bakterium"], correct: 1 },
    { q: "Was passiert mit Metall bei Kälte?", a:["Es zieht sich zusammen", "Es dehnt sich aus", "Es bleibt gleich"], correct: 0 },
    { q: "Was ist die häufigste Farbe im Universum?", a:["Schwarz", "Beige", "Blau"], correct: 1 },
    ...
    { q: "Puh, was für ein Ritt... 😜 ", a:["Wem sagst du das?!"], correct: 0 },
    //Finale Fragen
