...
const startImages = [
    { src: "DSCF5081.jpg", style: { top:"5%", left:"50%", transform:"translateX(-50%)" } }, // oben mittig
    { src: "DSCF3972.jpg", style: { bottom:"1%", left:"10%" } },                             // unten links
    { src: "DSCF2395.jpg", style: { bottom:"1%", right:"10%" } }                             // unten rechts
];
